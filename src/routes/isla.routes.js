...
router.post('/', verifyToken, checkRole(['ADMINISTRADOR', 'USUARIO']), IslaController.createIsla);
...
router.put('/:id/anular', verifyToken, checkRole(['ADMINISTRADOR', 'USUARIO']), IslaController.anularIsla);
